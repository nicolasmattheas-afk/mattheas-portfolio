      ...
      <main className="pt-20">
        ...
        <section className="relative min-h-[90vh] flex items-center px-6 overflow-hidden bg-black pt-10 md:pt-0">
          ...
          <div className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
            ...
            <div className="text-center md:text-left order-2 md:order-1">
              {/* MODIFICATION : text-neutral-200 */}
              <div className="inline-block mb-6 px-4 py-1.5 border border-neutral-800 bg-neutral-900/50 rounded-full text-xs font-medium tracking-widest uppercase text-neutral-200">
              ...
              {/* MODIFICATION : Gradient plus clair (to-neutral-300) */}
              <h2 className="text-2xl md:text-3xl text-transparent bg-clip-text bg-gradient-to-r from-white to-neutral-300 font-serif italic mb-8">
                Marketing Stratégique <br/> & Technologies Digitales
              </h2>
              {/* MODIFICATION : text-neutral-200 */}
              <p className="text-lg md:text-xl text-neutral-200 mb-10 max-w-xl leading-relaxed font-light mx-auto md:mx-0">
        ...
        <section id="about" className="py-24 px-6 bg-neutral-950 border-y border-neutral-900 scroll-mt-28">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="max-w-4xl mx-auto mb-24">
              {/* MODIFICATION : text-neutral-300 */}
              <h2 className="text-xs font-bold text-neutral-300 uppercase tracking-[0.2em] mb-4">À Propos</h2>
              <h3 className="text-3xl md:text-4xl font-bold text-white mb-8 leading-tight">Profil Hybride</h3>
              {/* MODIFICATION : text-neutral-200 */}
              <div className="prose prose-lg prose-invert text-neutral-200 leading-relaxed max-w-none">
                <p>
                ...
                <div className="flex flex-wrap gap-3 mt-8">
                   {/* MODIFICATION : text-neutral-100 (plus blanc) */}
                   <span className="px-4 py-2 bg-neutral-900 border border-neutral-800 rounded-full text-sm font-medium text-neutral-100">Anglais C1</span>
                   <span className="px-4 py-2 bg-neutral-900 border border-neutral-800 rounded-full text-sm font-medium text-neutral-100">Espagnol B2</span>
                   <span className="px-4 py-2 bg-neutral-900 border border-neutral-800 rounded-full text-sm font-medium text-neutral-100">Parcours International</span>
                </div>
              </div>
            </div>
            ...
            <div id="skills" className="border-t border-neutral-900 pt-24 scroll-mt-28">
              <div className="text-center mb-16">
                {/* MODIFICATION : text-neutral-300 */}
                <h2 className="text-xs font-bold text-neutral-300 uppercase tracking-[0.2em] mb-4">Expertise</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
                <div className="p-8 rounded-2xl bg-black border border-neutral-800 hover:border-neutral-600 transition-colors group">
                  ...
                  {/* MODIFICATION : text-neutral-300 */}
                  <p className="text-sm text-neutral-300">Digital & Multicanal, Analyse de données, Suivi de KPI, Veille sectorielle.</p>
                </div>
                ...
                <div className="p-8 rounded-2xl bg-black border border-neutral-800 hover:border-neutral-600 transition-colors group">
                  ...
                  <p className="text-sm text-neutral-300">Création (Vidéo, Visuels), Storytelling, Gestion Réseaux Sociaux (Linkedin, Meta, TikTok).</p>
                </div>
                ...
                <div className="p-8 rounded-2xl bg-black border border-neutral-800 hover:border-neutral-600 transition-colors group">
                  ...
                  <p className="text-sm text-neutral-300">IA LLM et Générative (Gemini, ChatGPT, MidJourney, Perplexity, Nano Banana), Prompt Engineering.</p>
                </div>
              </div>
              ...
              <div className="border border-neutral-800 rounded-3xl p-8 md:p-12 bg-black/40">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                  ...
                  <div className="space-y-4">
                    ...
                    {/* MODIFICATION : text-neutral-200 pour toute la liste */}
                    <ul className="space-y-3">
                      <li className="flex items-center gap-2 text-neutral-200 text-sm"><span className="w-1.5 h-1.5 bg-white rounded-full"></span>Suite Adobe</li>
                      <li className="flex items-center gap-2 text-neutral-200 text-sm"><span className="w-1.5 h-1.5 bg-white rounded-full"></span>Canva</li>
                      <li className="flex items-center gap-2 text-neutral-200 text-sm"><span className="w-1.5 h-1.5 bg-white rounded-full"></span>Meta Spark AR Studio</li>
                    </ul>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-3">
                      <li className="flex items-center gap-2 text-neutral-200 text-sm"><span className="w-1.5 h-1.5 bg-white rounded-full"></span>HubSpot</li>
                      <li className="flex items-center gap-2 text-neutral-200 text-sm"><span className="w-1.5 h-1.5 bg-white rounded-full"></span>Google Analytics</li>
                    </ul>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-3">
                      <li className="flex items-center gap-2 text-neutral-200 text-sm"><span className="w-1.5 h-1.5 bg-white rounded-full"></span>Jira / Slack / Discord</li>
                      <li className="flex items-center gap-2 text-neutral-200 text-sm"><span className="w-1.5 h-1.5 bg-white rounded-full"></span>LuQI</li>
                      <li className="flex items-center gap-2 text-neutral-200 text-sm"><span className="w-1.5 h-1.5 bg-white rounded-full"></span>Cision</li>
                    </ul>
                  </div>
                   ...
                   <div className="space-y-4">
                    ...
                    <ul className="space-y-3">
                      <li className="flex items-center gap-2 text-neutral-200 text-sm"><span className="w-1.5 h-1.5 bg-white rounded-full"></span>Office 365 (Word, Excel)</li>
                      <li className="flex items-center gap-2 text-neutral-200 text-sm"><span className="w-1.5 h-1.5 bg-white rounded-full"></span>PowerPoint</li>
                      <li className="flex items-center gap-2 text-neutral-200 text-sm"><span className="w-1.5 h-1.5 bg-white rounded-full"></span>Google Workspace</li>
                    </ul>
                  </div>
        ...
        <section id="work" className="py-24 px-6 max-w-7xl mx-auto border-t border-neutral-900 scroll-mt-28">
          <div className="flex justify-between items-end mb-20">
            <div>
              {/* MODIFICATION : text-neutral-300 */}
              <h2 className="text-xs font-bold text-neutral-300 uppercase tracking-[0.2em] mb-4">Portfolio</h2>
        ...
        <section id="contact" className="bg-neutral-950 text-white py-24 px-6 relative overflow-hidden border-t border-neutral-900 scroll-mt-28">
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            {/* MODIFICATION : text-neutral-200 */}
            <p className="text-neutral-200 mb-12 text-lg max-w-2xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-6">
              ...
              <a href="tel:0761069444" className="group flex items-center gap-3 px-8 py-4 bg-transparent border border-neutral-800 text-white hover:border-white rounded-full transition-all">
                <Phone className="text-white group-hover:text-white transition-colors" />
              ...
              <div className="flex gap-4">
                <a href="https://www.linkedin.com/in/mattheas-nicolas" target="_blank" rel="noopener noreferrer" className="p-4 bg-neutral-900 hover:bg-white hover:text-black rounded-full transition-all border border-neutral-800 group">
                  <Linkedin className="text-white group-hover:text-black transition-colors" />
                </a>
              </div>
            </div>

            {/* MODIFICATION : text-neutral-400 (plus clair que le 600 d'avant) */}
            <div className="mt-24 pt-8 border-t border-neutral-900 text-neutral-400 text-sm flex flex-col md:flex-row justify-between items-center gap-4">
